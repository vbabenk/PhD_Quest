# Pre-Defense Period
![Перед початком процедури захисту дисертації, тобто до 01 січня 4-го року навчання в аспірантурі, необхідно виконати 2 найважливіших пункти](TheProcedure-Page-1.png)
